var Ship = cc.Sprite.extend({
    speed:220,
    bulletSpeed:DS.BULLET_SPEED.SHIP,
    HP:5,
    bulletTypeValue:1,
    bulletPowerValue:1,
    throwBombing:false,
    ...
    update:function (dt) {
        ...
        if (sys.platform == 'browser') {
            ...
            if ((DS.KEYS[cc.KEY.a] || DS.KEYS[cc.KEY.left]) && pos.x >= 0) {
                pos.x -= dt * this.speed;
            }
            if ((DS.KEYS[cc.KEY.d] || DS.KEYS[cc.KEY.right]) && pos.x <= screenWidth) {
                pos.x += dt * this.speed;
            }
...
//        var a = Bullet.getOrCreateBullet(this.bulletSpeed, "W1.png", DS.ENEMY_ATTACK_MODE.NORMAL, 3000, DS.UNIT_TAG.PLAYER_BULLET);
//        a.setPosition(p.x + offset, p.y + 3 + cs.height * 0.3);
//
//        var b = Bullet.getOrCreateBullet(this.bulletSpeed, "W1.png", DS.ENEMY_ATTACK_MODE.NORMAL, 3000, DS.UNIT_TAG.PLAYER_BULLET);
