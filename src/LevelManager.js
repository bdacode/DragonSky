var LevelManager = cc.Class.extend({
    ...
    loadLevelResource:function(deltaTime){
        if(DS.ACTIVE_ENEMIES>= this._currentLevel.enemyMax){
            return;
        }
        //load enemy
    ...
    addEnemyToGameLayer:function(enemyType){
        ...
        switch (addEnemy.moveType) {
            ...
            case DS.ENEMY_MOVE_TYPE.HORIZONTAL:
                ...
                break;
            case DS.ENEMY_MOVE_TYPE.OVERLAP:
